          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            >
              <div className="d-flex justify-content-between w-100">
                <Nav.Link
                  href="https://www.linkedin.com/in/tejpalTomerR/"
                ...
                <Nav.Link
                  href="https://github.com/tejpalTomerR"
                  className="nav-item cursor-pointer"
                  target="_blank"
                >
                  <GitHubIcon />
                ...
                <Nav.Link
                  href="https://medium.com/@tejpalTomerR"
                  className="nav-item cursor-pointer"
                  target="_blank"
                >
                  <img
                ...
                <Nav.Link
                  href="https://stackoverflow.com/users/8057486/tejpal-tomer"
                  className="nav-item cursor-pointer"
                  target="_blank"
                >
                  <img
